...
/// Random lock on shot.
/// </summary>
[AddComponentMenu("Game/Shot Pattern/Random Shot (Lock On)")]
public class RandomLockOnShot : RandomShot
{
    ...
    void AimTarget()
    {
        ...
        if (targetTransform != null)
        {
            randomCenterAngle = Util.GetAngleFromTwoPosition(transform, targetTransform);
        }
    }
